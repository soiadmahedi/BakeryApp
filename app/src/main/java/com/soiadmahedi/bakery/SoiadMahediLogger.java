...
public class SoiadMahediLogger {
	...
	* Uses:
	* <br>
	*  - "SoiadMahediLogger.broadcastLog(String)" to manually send a debug log that's then viewable in Logcat Reader
	*  - "SoiadMahediLogger.stopLogging()" to stop logging
	*/
	...
	public static void broadcastLog(String log) {
		Context context = SoiadMahediApps.getContext();
